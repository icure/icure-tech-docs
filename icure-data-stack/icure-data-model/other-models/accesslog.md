...
| :--- | :--- | :--- |
| `id * ` | [String](String) | The Id of the Access log. We encourage using either a v4 UUID or a HL7 Id  |
| `rev ` | [String](String) | The revision of the access log in the database, used for conflict management / optimistic locking.  |
...
| `objectId ` | [String](String) | Id of the object that is being requested.  |
| `accessType ` | [String](String) | The type of access  |
| `user ` | [String](String) | Id of the user making the requests  |
| `detail ` | [String](String) | Further details about the access  |
| `date ` | [Date](Date) | The date (unix epoch in ms) of logging, is filled instantaneously. format: date-time. |
